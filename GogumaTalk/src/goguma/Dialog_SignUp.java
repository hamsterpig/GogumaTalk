...
public class Dialog_SignUp  extends JDialog implements ActionListener, KeyListener{
	JPanel pnl;
	...
	Dialog_SignUp(){
		...
		pnl_c.setPreferredSize(new Dimension(230,230));;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btnY){
			...
			} else if(txpass_Check.getText().equals("") || txpass_Check.getText() == null){
				lbMSG.setText("Do not enter PW !");
				lbMSG.setForeground(Color.red);
			} else {
