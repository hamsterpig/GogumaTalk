...
public class Pnl_MultiChatRoom extends JPanel{
	...
	Pnl_MultiChat mtc;
	int myNum=0;
	Pnl_MultiChatRoom(Pnl_MultiChat multiChat,String title,String image,String password, String contents, int maxnum,int curnum){
