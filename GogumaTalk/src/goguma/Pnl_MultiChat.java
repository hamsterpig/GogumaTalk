...
public class Pnl_MultiChat extends Pnl_SideBar implements ActionListener,MouseListener{
	JLabel lbTitle;
	JPanel pnlNorth;
	static JPanel pnlCenter;
	JButton btnFind,btnAdd;
	JTextField tfFind;
	ArrayList<Pnl_MultiChatRoom> chatroom;
	...
	Pnl_MultiChat(){
		...
		chatroom = new ArrayList<Pnl_MultiChatRoom>();
		...
		scrCenter = new JScrollPane(pnlCenter,JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
	...
	public void addRoom(String title,String image,String password, String contents, int maxnum,int curnum){
		//방 추가 메소드
		pnlCenter.add(new Pnl_MultiChatRoom(this,title,image,password,contents,maxnum,curnum));
